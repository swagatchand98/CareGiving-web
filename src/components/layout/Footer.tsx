    ...
    <footer className="bg-gray-100 pt-12 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">Caregiving</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/services/details/elder-care" className="text-gray-600 hover:text-black">
                  Elder Care
                </Link>
              </li>
              <li>
                <Link href="/services/details/child-care" className="text-gray-600 hover:text-black">
                  Child Care
                </Link>
              </li>
              <li>
                <Link href="/services/details/special-needs" className="text-gray-600 hover:text-black">
                  Special Needs Care
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-200 pt-8 text-center text-sm text-gray-600">
          <p>© {new Date().getFullYear()} Caregiving. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
