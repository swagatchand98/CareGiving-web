      ...
      <main className="flex-grow">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col items-center justify-center h-full">
              <div className="flex flex-col md:flex-row items-center justify-between w-full mb-12 sm:mb-16 md:mb-24 max-w-7xl mx-auto">
                {/* Left Image */}
                <div className="w-3/4 sm:w-2/3 md:w-1/4 mb-10 sm:mb-12 md:mb-0 max-w-[250px] reveal reveal-left">
                  <img 
                    src="/images/placeholders/caregiver.jpg.svg" 
                    alt="Elder Care" 
                    className="w-full mx-auto hover-scale"
                  />
                </div>
                
                {/* Center Text */}
                <div className="w-full sm:w-4/5 md:w-2/4 text-center px-2 sm:px-4 mb-10 sm:mb-12 md:mb-0 reveal">
                  <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-blue-900 mb-4 sm:mb-6 animate-gradient-text">
                ...
                {/* Right Image */}
                <div className="w-3/4 sm:w-2/3 md:w-1/4 mt-4 sm:mt-6 md:mt-0 max-w-[250px] reveal reveal-right">
                  <img 
              ...
              {/* Stats Section */}
              <div className="bg-white rounded-xl shadow-lg p-6 sm:p-8 md:p-10 w-full max-w-4xl flex flex-col md:flex-row justify-between items-center mb-12 sm:mb-16 md:mb-24 mx-auto reveal">
                {/* Stat 1 */}
                <div className="flex items-center mb-8 sm:mb-10 md:mb-0 w-full md:w-auto stagger-fade-in-up">
                  <div className="mr-4 sm:mr-6">
                    <div className="w-16 h-16 sm:w-20 sm:h-20 flex items-center justify-center animate-pulse-slow">
                  ...
                  <div>
                    <h3 className="text-3xl sm:text-4xl font-bold mb-1" data-count="2000" data-format="plus">0</h3>
                ...
                <div className="flex items-center mb-8 sm:mb-10 md:mb-0 w-full md:w-auto stagger-fade-in-up">
                  ...
                  <div>
                    <h3 className="text-3xl sm:text-4xl font-bold mb-1" data-count="10" data-format="plus">0</h3>
                    <p className="text-base sm:text-lg text-gray-600">Cities</p>
                  </div>
                </div>
                
                {/* Stat 3 */}
                <div className="flex items-center w-full md:w-auto stagger-fade-in-up">
                  <div className="mr-4 sm:mr-6">
                    <div className="w-16 h-16 sm:w-20 sm:h-20 flex items-center justify-center animate-pulse-slow">
                      <svg width="48" height="48" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="sm:w-14 sm:h-14">
                  ...
                  <div>
                    <h3 className="text-3xl sm:text-4xl font-bold mb-1" data-count="5000" data-format="plus">0</h3>
              ...
              <div className="text-center reveal">
                <button 
                  ...
                  className="flex items-center justify-center gap-2 sm:gap-3 bg-white border border-gray-300 rounded-lg px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg text-gray-700 font-medium shadow-md hover:bg-gray-50 transition-colors hover-lift btn-pulse"
                >
                  <img 
                    src="/icons/google.svg" 
                    alt="Google" 
                    className="w-5 h-5 sm:w-6 sm:h-6 animate-pulse-slow"
                    onError={(e) => {
        ...
        >
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col items-center justify-center h-full">
              {/* Heading */}
              <div className="text-center mb-12 sm:mb-16 md:mb-20 max-w-3xl mx-auto reveal">
                <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-blue-900 mb-4 sm:mb-6 mt-6 sm:mt-8 md:mt-10 animate-gradient-text">
                  What's waiting for you on the app?
                </h2>
                <p className="text-lg sm:text-xl md:text-2xl text-gray-600 animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
              ...
              {/* Download Buttons */}
              <div className="mt-12 sm:mt-16 md:mt-20 lg:mt-24 flex flex-col sm:flex-row gap-4 justify-center reveal">
                <button className="flex items-center justify-center gap-2 bg-black text-white rounded-lg px-4 sm:px-6 py-2 sm:py-3 hover:bg-gray-800 transition-colors hover-lift btn-pulse">
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-center mb-12 reveal animate-gradient-text">Our Services</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {/* Service Card 1 */}
              <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow hover-lift reveal">
                ...
                <Link href="/services/details/elder-care" className="text-black font-medium hover:underline btn-pulse">
                  Learn More →
                </Link>
              </div>
              
              {/* Service Card 2 */}
              <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow hover-lift reveal" style={{ animationDelay: '0.2s' }}>
                <div className="rounded-lg h-40 mb-4 overflow-hidden">
                  <img 
                    src="/images/placeholders/child-care.svg" 
                    alt="Child Care" 
                ...
                <Link href="/services/details/child-care" className="text-black font-medium hover:underline btn-pulse">
                  Learn More →
                </Link>
              </div>
              
              {/* Service Card 3 */}
              <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow hover-lift reveal" style={{ animationDelay: '0.4s' }}>
                <div className="rounded-lg h-40 mb-4 overflow-hidden">
                  <img 
                    src="/images/placeholders/special-needs.svg" 
                ...
                <Link href="/services/details/special-needs" className="text-black font-medium hover:underline btn-pulse">
                  Learn More →
                </Link>
              </div>
            </div>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row items-center">
              <div className="md:w-1/2 mb-10 md:mb-0 md:pr-10 reveal reveal-left">
                <h2 className="text-3xl font-bold mb-6 animate-gradient-text">Become a Service Provider</h2>
                ...
                <ul className="space-y-3 mb-8 stagger-fade-in-up">
                  <li className="flex items-start">
                    <svg className="w-6 h-6 text-green-500 mr-2 flex-shrink-0 animate-pulse-slow" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="md:w-1/2 reveal reveal-right">
                <div className="bg-white rounded-lg shadow-lg p-8 hover-glow">
                  <div className="flex items-center mb-6 hover-lift">
                    <div className="w-12 h-12 rounded-full bg-black text-white flex items-center justify-center mr-4 animate-pulse-slow">
